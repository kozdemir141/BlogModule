            ...
            function (event) {
                ...
                $.post(actionUrl, dataToSend).done(function (data) {
                   ...
                   <div class="media mb-4">
                        <img class="d-flex mr-3 rounded-circle" src="https://randomuser.me/api/portraits/women/91.jpg" alt="">
                        ...
                        toastr.success(
                            `Dear ${commentAddAjaxModel.CommentDto.Comment.CreatedByName} Your Comment Has Been Added Succesfully.Example is Showing on Screen Now.Your Comment Will Be Shown After Approval`);
